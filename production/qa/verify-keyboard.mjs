...
fs.mkdirSync('production/revision',{recursive:true});fs.writeFileSync(process.argv[2]??'production/revision/keyboard-geometry-audit.json',JSON.stringify(report,null,2));console.log(JSON.stringify(report,null,2));if(!report.passed)process.exitCode=1;
