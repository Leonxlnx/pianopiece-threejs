...
const cases=[
 {name:'right-transfer',module:scratch+'/index-transition/proposed-rig.mjs',begin:106.65,end:107.55,events:[106.81,106.919774,106.923274,107.18,107.269683]},
 {name:'left-bass',module:scratch+'/bass-contact/delivery-p322/p322-candidate.mjs',begin:70.8,end:71.6,events:[70.878428,70.968428,71.178428,71.448396,71.461396,71.475396,71.508396,71.531337,71.568396]},
 {name:'left-idle-cutoff',module:scratch+'/idle-review-20260909/repair/fixed.mjs',begin:175.9,end:176.3,events:[176.02,176.065,176.201552]}
];
const results=[];
...
fs.writeFileSync('merged-leaf-parity.json',JSON.stringify(results,null,2));console.log(JSON.stringify(results));if(results.some(x=>!x.pass))process.exitCode=1;
