...
export class Pianist {
 ...
 const bassOriginalContacts:Record<string,{time:number;duration:number;contactZ:number|null;contactLift:number}> = {"p00322":{"time":71.178428,"duration":0.239968,"contactZ":null,"contactLift":0.0062824555694730895}};
