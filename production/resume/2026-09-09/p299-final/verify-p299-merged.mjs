...
const cases=[{name:'p299-scalar-guard',module:scratch+'/p299-transition/guard.mjs',begin:64.184354,end:68.448307,events:[65.7,65.9,66.03,66.18,66.30195,66.54,66.668093,67.016236,68.32,68.37,68.41,68.448307]}];
const results=[];
...
fs.writeFileSync('p299-merged-parity.json',JSON.stringify(results,null,2));console.log(JSON.stringify(results));if(results.some(x=>!x.pass))process.exitCode=1;
