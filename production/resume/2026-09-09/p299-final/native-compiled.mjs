...
function p299Idle(player, time) {
    if (time <= 64.184354 || time >= 67.016236)
        return;
    ...
    for (const fi of [1, 3]) {
        ...
        if (fi === 1 && previous.id === 'p00285' && next.id === 'p00302') {
            const since = time - previous.time - previous.duration;
            amount = 10 * p299Ease((time - 65.9) / .13) * p299Ease((next.time - time) / .30) + 5 * p299Ease(since / .025) * (1 - p299Ease((since - .05) / .10));
        }
