import { applyIdleNonthumb } from '/workspace/scratch/2e8cc8e77f98/climax-nonthumb-continuity/render-project/production/qa/compiled/idle-nonthumb.mjs';
import * as THREE from 'three';
import { GLTFLoader } from 'three/addons/loaders/GLTFLoader.js';
import { clamp, smooth, mix, v3, lowerBound } from '/workspace/scratch/2e8cc8e77f98/climax-nonthumb-continuity/render-project/production/qa/compiled/math.mjs';
import { keyX, isBlack, KEY_TOP, keySurfaceY } from '/workspace/scratch/2e8cc8e77f98/climax-nonthumb-continuity/render-project/production/qa/compiled/piano.mjs';
import { wristMotionSampler } from '/workspace/scratch/2e8cc8e77f98/climax-nonthumb-continuity/render-project/production/qa/compiled/wrist-motion.mjs';
import { ponytailMotion } from '/workspace/scratch/2e8cc8e77f98/climax-nonthumb-continuity/render-project/production/qa/compiled/ponytail-motion.mjs';
...
export class Pianist extends OriginalPianist {
    ...
    update(time, score, piano, pedal, energy) { super.update(time, score, piano, pedal, energy); releaseRepair(this, time, piano); p299Idle(this, time); virtualChordRest(this, time, piano); liveChordTransitions(this, time, piano); climaxNonthumbContinuity(this, time); climaxThumbContinuity(this, time); }
}
