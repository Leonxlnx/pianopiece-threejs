...
const {Pianist}=await import(process.env.DAYBREAK_RIG_MODULE?pathToFileURL(process.env.DAYBREAK_RIG_MODULE).href:'./render-project/production/qa/compiled/pianist.mjs');
import {GrandPiano,keyX,isBlack,keySurfaceY} from '/workspace/scratch/2e8cc8e77f98/climax-fingering-review/render-project/production/qa/compiled/piano.mjs';
import {pedalPosition,scoreEnergy} from '/workspace/scratch/2e8cc8e77f98/climax-fingering-review/render-project/production/qa/compiled/math.mjs';
const {wristMotionSampler}=await import(process.env.DAYBREAK_WRIST_MODULE?pathToFileURL(process.env.DAYBREAK_WRIST_MODULE).href:'/workspace/scratch/2e8cc8e77f98/climax-fingering-review/render-project/production/qa/compiled/wrist-motion.mjs');
...
const bytes=fs.readFileSync('/workspace/scratch/2e8cc8e77f98/final-film-2026-09-09/snapshots/dc1a0bfe8fa61c9a/public/assets/pianist.glb');
const gltf=await loader.parseAsync(bytes.buffer.slice(bytes.byteOffset,bytes.byteOffset+bytes.byteLength),'');
export const baseline=JSON.parse(fs.readFileSync(process.env.DAYBREAK_SCORE??new URL('./baseline-score.json',import.meta.url)));
