import * as THREE from 'three';import {Pianist as Base} from '../climax-nonthumb-continuity/supported.mjs';const smooth=x=>{x=Math.max(0,Math.min(1,x));return x*x*(3-2*x);};
