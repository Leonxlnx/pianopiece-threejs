...
export class Pianist extends OriginalPianist {
    plannedPose(hand, time) { const pose = super.plannedPose(hand, time); if (hand.side === 'R') {
    ...
    update(time, score, piano, pedal, energy) { super.update(time, score, piano, pedal, energy); releaseRepair(this, time, piano); p299Idle(this, time); virtualChordRest(this, time, piano); liveChordTransitions(this, time, piano); }
}
