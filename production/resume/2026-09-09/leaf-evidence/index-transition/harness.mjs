...
const {Pianist}=await import(process.env.DAYBREAK_RIG_MODULE?pathToFileURL(process.env.DAYBREAK_RIG_MODULE).href:'/workspace/scratch/2e8cc8e77f98/integrated-review/pianist-candidate-baked.mjs');
...
export const baseline=JSON.parse(fs.readFileSync(process.env.DAYBREAK_SCORE??'/workspace/scratch/2e8cc8e77f98/integrated-review/score-v11.json'));
