...
import { clamp, smooth, mix, v3, lowerBound } from '/workspace/sites/daybreak-piano-film/app/performance/math';
import { GrandPiano, keyX, isBlack, KEY_TOP, keySurfaceY } from '/workspace/sites/daybreak-piano-film/app/performance/piano';
import type { Note, Score, Hand, Telemetry } from '/workspace/sites/daybreak-piano-film/app/performance/types';
import { wristMotionSampler } from '/workspace/sites/daybreak-piano-film/app/performance/wrist-motion';
import { ponytailMotion } from '/workspace/sites/daybreak-piano-film/app/performance/ponytail-motion';
