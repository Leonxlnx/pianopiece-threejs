...
export class Pianist {
 ...
 if(this.wristMotion){const pose=this.wristMotion(hand.side,time);if(hand.side==='L'){pose.position.add(v3(-0.025,0.003,-0.03));pose.q.premultiply(new THREE.Quaternion().setFromAxisAngle(v3(0,1,0),-0.6981317007977318));}return pose;}
