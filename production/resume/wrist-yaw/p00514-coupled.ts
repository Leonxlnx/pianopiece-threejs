...
export class Pianist {
 ...
 if(this.wristMotion){const pose=this.wristMotion(hand.side,time);if(hand.side==='L'){pose.position.add(v3(-0.017409080684003146,0.008,-0.01500902809939774));pose.q.premultiply(new THREE.Quaternion().setFromAxisAngle(v3(0,1,0),-0.5235987755982988));}return pose;}
