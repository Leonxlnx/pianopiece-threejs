...
export class Pianist {
 ...
 if(this.wristMotion){const pose=this.wristMotion(hand.side,time);if(hand.side==='L')pose.q.premultiply(new THREE.Quaternion().setFromAxisAngle(v3(0,1,0),-10*Math.PI/180));return pose;}
