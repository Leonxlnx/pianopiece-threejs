...
const {Pianist}=await import(process.env.DAYBREAK_RIG_MODULE?pathToFileURL(process.env.DAYBREAK_RIG_MODULE).href:'./pianist-baseline.mjs');
...
const bytes=fs.readFileSync('/workspace/scratch/2e8cc8e77f98/lh-remaining/pianist.glb');
