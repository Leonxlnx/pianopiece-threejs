...
import { clamp, smooth, mix, v3, lowerBound } from '/workspace/scratch/2e8cc8e77f98/lh-shared-b3/compiled/math.mjs';
import { keyX, isBlack, KEY_TOP, keySurfaceY } from '/workspace/scratch/2e8cc8e77f98/lh-shared-b3/compiled/piano.mjs';
import { wristMotionSampler } from '/workspace/scratch/2e8cc8e77f98/lh-shared-b3/compiled/wrist-motion.mjs';
import { ponytailMotion } from '/workspace/scratch/2e8cc8e77f98/lh-shared-b3/compiled/ponytail-motion.mjs';
