            ...
            for (let fi = 0; fi < 5; fi++) {
                ...
                if (!n && fi === 0) {
                    ...
                    if (hand.side === 'R' && time >= 6.0390358363389325 && time <= 12.392821) {
                        const weight = smooth((time - 6.0390358363389325) / .10) * (1 - smooth((time - 11.85) / .54)), neutral = localPose(wp(hand.wrist), pose.q, v3(keyX(62), globalThis.DAYBREAK_NEUTRAL_Y??.757, globalThis.DAYBREAK_NEUTRAL_Z??.267));
