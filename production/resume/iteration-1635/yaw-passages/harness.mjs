...
const {Pianist}=await import('./'+(process.env.YAW_VARIANT??'baseline-rig')+'.mjs');
...
const bytes=fs.readFileSync('/workspace/scratch/2e8cc8e77f98/yaw-passages/pianist.glb');
