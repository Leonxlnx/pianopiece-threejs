...
const THUMB_REVIEW_CURVE=[{"t":179.943184,"offset":[0,0,0],"velocity":[0,0,0]},{"t":179.943544828,"offset":[0,0,0],"velocity":[0,0,0]},{"t":179.947184,"offset":[0,0,0.1],"velocity":[0,0,30.217595255190655]},{"t":179.950184,"offset":[0,0,0.2],"velocity":[0,0,40.54054054061478]},{"t":179.952184,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.95400884,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.959184,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.962184,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.963184,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.964184,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.966184,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.96844196,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":179.98648336,"offset":[0.225,0,0.3],"velocity":[9.766693232072994,0,0]},{"t":180.0153496,"offset":[0.45,0,0.3],"velocity":[0,0,0]},{"t":180.0514324,"offset":[0.45,0,0.3],"velocity":[0,0,0]},{"t":180.0875152,"offset":[0.45,0,0.3],"velocity":[0,0,0]},{"t":180.12359800000002,"offset":[0.45,0,0.3],"velocity":[0,0,0]},{"t":180.1596808,"offset":[0.45,0,0.3],"velocity":[0,0,0]},{"t":180.1957636,"offset":[0.45,0,0.3],"velocity":[0,0,0]},{"t":180.2318464,"offset":[0.45,0,0.3],"velocity":[0,0,0]},{"t":180.26071264,"offset":[0.225,0,0.3],"velocity":[-9.766693232072994,0,0]},{"t":180.27875404,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":180.29318716,"offset":[0,0,0.3],"velocity":[0,0,0]},{"t":180.303651172,"offset":[0,0,0],"velocity":[0,0,0]},{"t":180.304012,"offset":[0,0,0],"velocity":[0,0,0]}];
...
export class Pianist {
 ...
 const contactPose=(note:Note,at:number)=>{const anchor=this.plannedPose(hand,at),origin=finger.bones[0].position.clone().applyQuaternion(anchor.q).add(anchor.position),z=note.contactZ??this.contactDepth(origin.z,isBlack(note.midi),fi),touch=v3(keyX(note.midi),(hand.side==='R'&&prev?.id==='p00852'&&nxt?.id==='p00855'&&note.id==='p00855'&&time>=179.943184&&time<=180.304012?piano.contact(note.midi,z).y:keySurfaceY(note.midi,z,1))+(note.contactLift??.002),z);return localPose(anchor.position,anchor.q,touch,note.thumbOpposition??0);};
 const previous=prev&&prev.time+prev.duration<=time?prev:undefined,next=nxt&&nxt.time>=time?nxt:undefined;
 const end=previous?previous.time+previous.duration:-10,start=next?.time??1e6,gap=start-end;
 ...
 if(hand.side==='R'&&previous?.id==='p00852'&&next?.id==='p00855'&&time>179.943184&&time<180.304012){let i=1;while(THUMB_REVIEW_CURVE[i].t<time)i++;const a=THUMB_REVIEW_CURVE[i-1],b=THUMB_REVIEW_CURVE[i],dt=b.t-a.t,u=(time-a.t)/dt,offset=a.offset.map((v,k)=>(2*u**3-3*u*u+1)*v+(u**3-2*u*u+u)*dt*a.velocity[k]+(-2*u**3+3*u*u)*b.offset[k]+(u**3-u*u)*dt*b.velocity[k]);rotations[0].premultiply(new THREE.Quaternion().setFromEuler(new THREE.Euler(offset[0],offset[1],offset[2],'XYZ')));}
