...
fs.writeFileSync('repeat-nine-'+label+'-rows.json',JSON.stringify(rows));reports.push({label,rows:rows.length});}
fs.writeFileSync('repeat-nine-candidate.json',JSON.stringify(s));console.log(JSON.stringify(reports));
