...
fs.writeFileSync('repeat-v6-'+label+'-rows.json',JSON.stringify(rows));reports.push({label,rows:rows.length});}
fs.writeFileSync('repeat-v6-candidate.json',JSON.stringify(s));console.log(JSON.stringify(reports));
