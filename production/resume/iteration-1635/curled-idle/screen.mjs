...
process.env.DAYBREAK_RIG_MODULE=path.resolve('pianist-local40.mjs');const B=await import('./harness.mjs?candidate');
...
out.scope='1068 exact note midpoints plus start/end (1070), seven neutral contexts, both hands. Exact >65% owned triangles and all88 beveled key cores; R rows include opposing hand pairs. Strict count increases retained as regressions. No full-time collision pass inferred.';
