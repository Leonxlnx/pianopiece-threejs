...
export class Pianist {
 ...
 applyRhIdle(time,hand.side,fi,finger.bones,hand.wrist,base,previous,next);
 continue;
 }
...
const applyRhIdle = (()=>{
const idleNonthumbData = {"supportedIndexGaps":[],"curves":[{"hi":1,"fi":1,"previous":"p00216","previousEnd":49.883542,"next":"p00225","nextTime":51.325059,"knots":[[49.883542,0,0,0,0],[49.916,30,10,0,0],[50.025,30,10,0,0],[50.1,0,0,0,0]]},{"hi":1,"fi":1,"previous":"p00216","previousEnd":49.883542,"next":"p00225","nextTime":51.325059,"knots":[[51.035,0,0,0,0],[51.1,30,10,0,0],[51.255,30,10,0,0],[51.325059,0,0,0,0]]}]};
...
type Curve=Gap&{mode?:string;knots:number[][];firstTangent?:number[];lastTangent?:number[]};
