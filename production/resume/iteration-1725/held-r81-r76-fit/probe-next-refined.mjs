...
for(const finger of[5])for(const z of[.255,.256,.257,.258,.259,.260])for(const lift of[.001,.002,.003,.004,.005]){
...
rows.sort((a,b)=>a.cost-b.cost);fs.writeFileSync('next-refined-probes.json',JSON.stringify(rows,null,2));console.log(rows.slice(0,12));
