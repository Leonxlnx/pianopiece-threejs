...
import { KEY_TOP } from '/workspace/sites/daybreak-piano-film/production/qa/compiled/piano.mjs';
...
export function applyIdleNonthumb(time, side, fi, bones, wrist, base, previous, next) {
    ...
    if (fi === 1) {
        ...
        if (c) {
            const amount = smooth((base.y - KEY_TOP - .005) / .004) * smooth((base.z - .244) / .008) * smooth((time - c.previousEnd) / .25) * smooth((c.nextTime - time) / .32);
