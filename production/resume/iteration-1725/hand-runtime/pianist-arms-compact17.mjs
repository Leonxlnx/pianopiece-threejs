            ...
            for (let fi = 0; fi < 5; fi++) {
                ...
                if (!n && fi === 0) {
                    ...
                    if (hand.side === 'R' && time >= 6.0390358363389325 && time <= 12.392821) {
                        const weight = smooth((time - 6.0390358363389325) / .10) * (1 - smooth((time - 11.85) / .54)), neutral = localPose(wp(hand.wrist), pose.q, v3(keyX(62) + .01225 * smooth((time - 10.95) / .18) * (1 - smooth((time - 11.43) / .24)), .757, .267));
                ...
                if (!n && fi > 0) {
                    ...
                    if (openingRest > 0) {
                        const midi = [62, 64, 67, 69, 71][fi], touch = v3(keyX(midi), KEY_TOP + .016, .235), reference = localPose(wp(hand.wrist), pose.q, touch);
