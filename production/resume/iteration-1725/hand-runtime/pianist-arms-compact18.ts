...
export class Pianist {
 ...
 if(hand.side==='R'&&time>=6.0390358363389325&&time<=12.392821){const weight=smooth((time-6.0390358363389325)/.10)*(1-smooth((time-11.85)/.54)),neutral=localPose(wp(hand.wrist),pose.q,v3(keyX(62)+.01525*smooth((time-10.95)/.18)*(1-smooth((time-11.43)/.24)),.757,.267));idlePose.forEach((q,j)=>q.slerp(neutral[j],weight));}
