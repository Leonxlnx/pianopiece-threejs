...
const dir='approach-waypoint',variants=process.argv.slice(2).length?process.argv.slice(2):['lift35','lift50','long35','long50'];
const base=JSON.parse(fs.readFileSync('approach-research/baseline/surfaces.json')),baseRows=new Map(base.rows.map(r=>[r.time,r]));
