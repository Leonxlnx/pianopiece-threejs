...
for(let i=0;i<=Math.ceil((end-start+.05)*960);i++)times.push(Math.min(start-.025+i/960,end+.025));
...
assert.ok(ordered.every((t,i)=>i===0||(t>ordered[i-1]&&t-ordered[i-1]<=1/960+1e-10)));
